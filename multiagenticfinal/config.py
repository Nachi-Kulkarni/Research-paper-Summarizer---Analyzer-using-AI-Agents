...
# --- Model Selection ---
# Ollama models
_DEFAULT_OLLAMA_MODEL = "gemma3:4b" # A common, smaller Gemma model for Ollama
...
OPENROUTER_MODEL_CODE = os.getenv("OPENROUTER_MODEL_CODE", "deepseek/deepseek-chat-v3-0324:free") # For code generation via OpenRouter
